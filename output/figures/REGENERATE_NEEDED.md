...
Run `python main.py` once on your machine and these will be produced
automatically alongside the rest. All three have been visually verified
to compile correctly with synthetic test data — only the input data
needs to be real.
